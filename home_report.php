    ...
    <div class="well bs-component">
        <form class="form-horizontal">
            <fieldset>
                ...
                <a class="btn btn-primary" href="laporan.php" target="_blank"><i class='bx bx-printer'></i> Laporan Penjualan PDF</a>
                <a class="btn btn-danger" href="home_payment.php" target="_blank"><i class='bx bx-printer'></i> Laporan Pembayaran Gaji PDF</a>
                <a class="btn btn-info" href="supply.php" target="_blank"><i class='bx bx-printer'></i> Laporan Pembelian Supply PDF</a>
