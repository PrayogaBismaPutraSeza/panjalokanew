...
<div id="page-inner">
    <div class="row">
        <div class="col-md-12">
            <h1 class="page-head-line">Laporan Penjualan</h1>
                    ...
                    <div class="card-body bg-white py-2 px-1 border-laporan">
                        <div class="row mx-auto align-items-center">
                            <div class="col-auto m-pr-1">
                                <div class="bg-icon">
                                    <i class="fa fa-user fa-2x" style="margin-left:42px;"></i>
                                </div>
                            </div>
                            <div class="col-auto pl-0 pt-2">
                                ...
                                <h4 class="1" style="margin-left:45px;"><?php
                ...
                <div class="col-6 col-sm-6 col-md-6 col-lg-3 mb-3 m-pr-0">
                    <div class="card-body bg-white py-2 px-1 border-laporan">
                        <div class="row mx-auto align-items-center">
                            <div class="col-auto m-pr-1">
                                <div class="bg-icon">
                                    <i class="fa fa-shopping-cart fa-2x" style="margin-left:7px;"></i>
                                </div>
                            </div>
                            <div class="col-auto pl-0 pt-2">
                                ...
                                <h4 class="1" style="margin-left:10px;"><?php $itungpeterjual = mysqli_query($conn, "SELECT SUM(quantity) as jumlahterjual FROM tb_nota");
                        ...
                        <div class="row mx-auto align-items-center">
                            ...
                            <div class="col-auto pl-0 pt-2">
                                ...
                                <h4 class="1">Rp<?php
                                                ...
                                                if ($cekrow3 > 0) {
                                                    echo number_format($itungtotal2);
                                                } ?></h4>
                            </div>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-tittle">
                        ...
                        <a class="btn btn-primary" href="report_sell.php" target="_blank"><i class='bx bx-printer'></i> Laporan Penjualan PDF</a>
                    </div>
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td>Rp<?php echo number_format($d['totalbeli']) ?></td>
                                    <td>Rp<?php echo number_format($d['pembayaran']) ?></td>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger btn-xs" href="?hapus=<?php echo $nota ?>" onclick="javascript:return confirm('Hapus Data laporan - <?php echo $d['no_nota'] ?> ?');">
