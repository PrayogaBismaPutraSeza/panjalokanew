    ...
    <div class="card small mb-3">
        ...
        <div class="card-body p-2">
            <div class="row">
                ...
                <div class="col-8 mb-2 pl-0">
                    <input type="text" class="form-control form-control-sm bg-white" value="<?php echo $tgl ?>" id="date-time" readonly>
                </div>
    ...
    <div class="card small mb-3">
        ...
        <div class="card-body p-2">
            ...
            if(isset($_POST['alamat_pelanggan']))
            {
                ...
                if ($tambahPel){
                    echo '<script>alert("Tambah Data Pelanggan Berhasil");window.location="home_kasir.php"</script>';
                } else {
...
<div class="col-lg-9" id="print">
    ...
    <div class="row print-none">
        ...
        <div class="col-6 col-lg-2 m-pr-0">
            ...
            <input type="text" class="form-control form-control-sm bg-white" id="harga_jual" readonly
             onchange="total()">
        </div>
...
if(isset($_POST['tambahcuy'])){
    ...
    if ($stock < $quantity) {
    echo '<script>alert("Oops! Jumlah pengeluaran lebih besar dari stok ...");window.location="home_kasir.php"</script>';
    }   
    else{
     $insert = mysqli_query($conn, "INSERT INTO keranjang (idproduk,quantity) VALUES ('$idproduk','$quantity')");
      if($insert){
        ...
        echo '<script>window.location="home_kasir.php"</script>';
     }
                            ...
                            //proses    
                                ...
                                $insert1 = mysqli_query($conn, "UPDATE produk SET stock='$sisa1' WHERE idproduk='$idproduk'");
                                    if($insert1){
                                        ...
                                        echo '<script>alert("Data Berhasil Di Hapus");window.location="home_kasir.php"</script>';
                                    } else {
