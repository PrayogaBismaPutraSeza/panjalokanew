                            ...
                            <?php
                                 ...
                                 while($d=mysqli_fetch_array($data_produk)){
                                    ...
                                    <tr>
                                        ...
                                        <td style="border: 1px solid #dee2e6;">Rp.<?php echo ($d['harga_jual']) ?></td>
                                        <td style="border: 1px solid #dee2e6;">Rp.<?php echo ($total) ?></td>
                                    </tr>		
                        <?php }?>
					</tbody>
                    <tr>
                        ...
                        <th class="bg-light" style="border: 1px solid #dee2e6;font-weight:600;">Rp.<?php echo ($checkdb['totalbeli']) ?></th>
                    </tr>
                    <tr>
                        <th class="d-none d-sm-block d-md-block border-0 bg-white"></th>
                        <th class="border-0 bg-white"></th>
                        ...
                        <th class="bg-light" style="border: 1px solid #dee2e6;font-weight:600;">Rp.<?php echo ($checkdb['pembayaran']) ?></th>
                    </tr>
                    <tr>
                        <th class="d-none d-sm-block d-md-block border-0 bg-white"></th>
                        <th class="border-0 bg-white"></th>
                        ...
                        <th class="bg-light" style="border: 1px solid #dee2e6;font-weight:600;">Rp.<?php echo ($checkdb['kembalian']) ?></th>
                    </tr>
                </table>
